...
st.markdown("""
    <style>
        ...
        /* Make each column look like a card */
        ...
        /* Slightly tighter padding for the KPI row (first row of columns) */
        div[data-testid="column"] > div.kpi {
            padding-top: 0.4rem;
...
# ====================================================
# INPUTS – 4 SECTIONS SIDE BY SIDE
# ====================================================
...
# ---------- CASA ----------
with col_casa:
    st.markdown('<div class="section-title">🏦 CASA (Salary)</div>', unsafe_allow_html=True)
...
# ---------- RETAIL LOANS ----------
with col_retail:
    st.markdown('<div class="section-title">🏠 Retail Loans</div>', unsafe_allow_html=True)
...
with col_wealth:
    st.markdown('<div class="section-title">📈 Wealth, Insurance & CMS/APIs</div>', unsafe_allow_html=True)
...
# ====================================================
# KPI BAR (TOP) – USE LIGHTER "CARD" VIA CLASS
# ====================================================
